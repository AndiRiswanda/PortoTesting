    ...
    <>
          ...
          <div className="grid md:grid-cols-12 gap-6 md:gap-10 items-center">
            ...
            <div className="md:col-span-7 text-center md:text-left px-4 md:px-0">
              ...
              <div className="mt-6 flex flex-wrap md:flex-nowrap justify-center md:justify-start gap-3">
                <a href="/about" className="px-5 py-2 rounded-md bg-brand text-white hover:opacity-90">About me</a>
                <a href="/blog" className="px-5 py-2 rounded-md bg-white/10 text-gray-200 border border-white/20 hover:bg-white/20">Read blog</a>
              </div>
      ...
      <section className="max-w-5xl mx-auto px-4 md:px-6 pb-16">
        <div className="flex items-end justify-between">
          ...
          <a href="/blog" className="text-brand hover:text-white text-sm">View all</a>
        </div>
